...
from ..handlers.create import create_account_handler
from ....application.response import error_response


async def create_account_endpoint(request: Request) -> JSONResponse:
    """
    ...
    try:
        ...
        id: int = await create_account_handler(data)
        url = request.url_for("get_account_by_id", id=str(id))
